...
/***/ "./src/modules/removeMidBlock.js":
/*!***************************************!*\
  !*** ./src/modules/removeMidBlock.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"removeChangingBlocks\": () => (/* binding */ removeChangingBlocks)\n/* harmony export */ });\nfunction removeChangingBlocks() {\n      const midElements = document.querySelectorAll('.midblock')\n            for (let counter = 0; counter < midElements.length; counter++){\n                  midElements[counter].innerHTML ='';\n                  midElements[counter].remove();\n            }\n}\n\n//# sourceURL=webpack://guthrat-immobilien/./src/modules/removeMidBlock.js?");
